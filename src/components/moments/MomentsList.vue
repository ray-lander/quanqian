<template>
	<div id="moments">
		<div class="moments_header clearfix">
		...
		<div class="moments_user clearfix">
			<div class="fl">
				<router-link
					tag="span"
					to="/index/moments/friendslist"
					class="iconfont icon-tongxunlu phone_list"
				>通讯录</router-link>
			</div>
			<div class="fr clearfix">
				<span class="fl">啦啦</span>
				<img class="fl" src="../../assets/img/666.jpg" alt>
			</div>
		</div>
		<div class="weui-cell moments__post">
			...
			<div class="weui-cell__bd">
				...
				<div class="toolbar">
					...
					<div>
						<div id="actionMenu" class="actionMenu slideIn" v-show="this.actionBtn">
							<span class="actionBtn" id="love_btn" @click="this.showAction">
								<i class="iconfont icon-aixin"></i>赞
							</span>
							<span class="actionBtn" id="comment_btn" @click="this.showAction">
								<i class="iconfont icon-xiaoxi"></i>评论
							</span>
							<span class="actionBtn" id="share_btn" @click="this.showAction">
								<i class="iconfont icon-zhuanfa"></i>转发
							</span>
							<span class="actionBtn" id="sava_btn" @click="this.showAction">
								<i class="iconfont icon-shoucang1"></i>收录
							</span>
						</div>
					</div>
					<span id="actionToggle" class="actionToggle iconfont icon-xiaoxi" @click="this.showAction"></span>
				</div>
				<!-- 赞／评论区 -->
				<div class="user_con">
					<p class="liketext">
					...
					<div class="comment_list">
						<p>
							<span>哈哈：</span><span>赞一下</span>
						</p>
						<p>
							<span>哦哦：</span><span>不赞不是中国人</span>
						</p>
					</div>
				</div>
			</div>
		...
		<div class="write_box clearfix">
			<span class="fl"><input type="text"></span>
			<img class="fl" src="../../assets/biaoqing.png" alt="">
			<button class="fl" type="button">发送</button>
		</div>
	</div>
</template>
<script>
